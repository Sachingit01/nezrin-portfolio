...
const socialLinks = [
  ...
  },
  {
    ...
    icon: <Youtube className="text-[#b89b55]" size={30} />,
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {socialLinks.map((link, index) => (
          <motion.a
            ...
            className="flex gap-6 p-6 bg-[#f2ebdc] bg-noise hover:shadow-md rounded-md h-40 transition duration-300"
          >
            <div className="flex flex-col gap-14 w-full justify-between">
              <div className="flex justify-between">
                {link.icon}
                <ExternalLink className="text-[#b89b55]" />
              </div>
